...
describe("Services Service", () => {
  ...
  describe("getServices", () => {
    it("should return services", async () => {
      ...
      (servicesRepository.getServices as jest.Mock).mockResolvedValue({
        rows: mockRows,
      });
  ...
  describe("deleteService", () => {
    it("should delete service", async () => {
      (servicesRepository.deleteService as jest.Mock).mockResolvedValue(
        undefined,
      );
  ...
  describe("createService", () => {
    it("should create service", async () => {
      ...
      (servicesRepository.createService as jest.Mock).mockResolvedValue(
        mockService,
      );
  ...
  describe("updateService", () => {
    it("should update service", async () => {
      ...
      (servicesRepository.updateService as jest.Mock).mockResolvedValue(
        mockService,
      );
